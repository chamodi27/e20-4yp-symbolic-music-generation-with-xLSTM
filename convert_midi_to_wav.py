...
midi_dir = "/scratch1/e20-fyp-xlstm-music-generation/e20fyptemp1/fyp-musicgen/melody_rnn/output/generated_samples_for_eval"
wav_dir = os.path.join(midi_dir, "wavs")
